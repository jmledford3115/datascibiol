...
## Review
At this point, you should have a GitHub account and made your first push. We also installed the `tidyverse` and `nycflights13` libraries.  
...
## Types of Data
There are five frequently used `classes` of data (we won't use raw): 1. numeric, 2. integer, 3. character, 4. logical, 5. complex.
```{r}
my_numeric <- 42
