...
[Eurasian pygmy owl](https://en.wikipedia.org/wiki/Eurasian_pygmy_owl)

```r
owls <- select(homerange, "common.name", "order", "family", "genus", "species", "mean.mass.g", "log10.mass")
...
```
## # A tibble: 9 × 7
##   common.name        order        family    genus species mean.mass.g log10.mass
##   <chr>              <fct>        <chr>     <chr> <chr>         <dbl>      <dbl>
## 1 boreal owl         strigiformes strigidae aego… funere…       119         2.08
## 2 long-eared owl     strigiformes strigidae asio  otus          252         2.40
## 3 little owl         strigiformes strigidae athe… noctua        156.        2.19
## 4 Eurasian eagle-owl strigiformes strigidae bubo  bubo         2191         3.34
## 5 great horned owl   strigiformes strigidae bubo  virgin…      1510         3.18
## 6 Eurasian pygmy owl strigiformes strigidae glau… passer…        61.3       1.79
## 7 snowy owl          strigiformes strigidae nyct… scandi…      1920         3.28
## 8 tawny owl          strigiformes strigidae strix aluco         519         2.72
## 9 barn owl           strigiformes tytonidae tyto  alba          285         2.45
```
...
[caracara](https://en.wikipedia.org/wiki/Caracara)


```r
birds <- filter(homerange, taxon=="birds")
birds <- select(birds, "common.name", "genus", "species", "mean.hra.m2")
arrange(birds, mean.hra.m2)
```
...
##    <chr>                   <chr>       <chr>              <dbl>
##  1 indigo bunting          passerina   cyanea             1052.
##  2 Carolina wren           thryothorus ludovicianus       1214.
##  3 yellow-breasted chat    icteria     virens             1335.
##  4 white-eyed vireo        vireo       griseus            1335.
##  5 American yellow warbler setophaga   petechia           1700.
##  6 least flycatcher        empidonax   minimus            1781.
##  7 American redstart       setophaga   ruticilla          1942.
##  8 inca dove               scardafella inca               2590.
##  9 Dartford warbler        sylvia      undata             2800 
## 10 wrentit                 chamaea     fasciata           3237.
## # ℹ 130 more rows
```
