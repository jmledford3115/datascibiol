...
Notice that the homerange data has "NA" in the csv file and this is the default NA indicator for read_csv, but other functions have different defaults so it's always good to check. 
```{r}
glimpse(homerange)
```
