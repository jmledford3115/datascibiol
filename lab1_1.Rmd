...
## GitHub and Git
[**GitHub**](www.github.com) is a file stoage and management site used mostly by programmers. Programmers upload code to repositories (folders) and make it publicly available.  
...
Most programmers use both **GitHub** and **Git** to manage their projects. However, **Git** is glitchy and hard to work with- especially in a classroom. If you want to try and use **Git**, then follow the directions [here](https://jmledford3115.github.io/datascibiol/setup.html). Otherwise, we will stick to using **GitHub**.


## GitHub Desktop
The easiest way to manage your GitHub repositories is to use [GitHub desktop](https://desktop.github.com/). This is a super helpful tool that will allow you to manage all of your files. Highly recommended!  
