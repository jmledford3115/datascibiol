...
I have made a repository for our class titled: [BIS15-W20-DataScienceBiologists](https://github.com/FRS417-DataScienceBiologists). Once you have accepted the invitation to join the repository, you should be able to login to GitHub and see this organization or click on the link above.  
...
6. On left toolbar click "Collaborators"  
...
In our class GitHub, you will see a directory called `BIS15-W20-DataScienceBiologists`. From within GitHub Desktop, clone this folder to your desktop. Also clone your new personal repository. At the start of each class you will need to repeat this process.  
