...
## Clone `class_files` and `your folder`
In our class GitHub, you will see a directory called `class_files`. From within GitHub Desktop, clone this folder to your desktop. Next, clone the folder assigned to your username to the desktop. At the start of each class you will need to repeat this process.  
