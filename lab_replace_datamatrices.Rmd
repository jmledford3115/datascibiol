...
4. Write your data frame to a csv file!
...
We can add a new birds data with the `rbind()` function, known as row bind. it will bind our new vector to our data frame row-wise.
```{r}
...
6. What is the class of the scientist column. Use and R command to see all the unique levels.
```{r}
