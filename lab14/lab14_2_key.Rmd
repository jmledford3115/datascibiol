...
```{r}
#?plotMissing
plotMissing(sug, main=NULL)
plotMissing(sug, main=NULL, reorder=1) #the individuals ordered according to the value of their phenotype
#?plotMap
plotMap(sug)
...
```{r}
iplotMap(sug) #D7MIT31 #iplotMap creates an interactive genetic map.
```
...
```{r}
iplotCurves(grav$pheno, chartOpts=list(curves_xlab="Time (hrs)", curves_ylab="Response"))
```
...
iplotCurves(phe, times, phe[,times==2 | times==4], phe[,times==4 | times==6],
            ...
            chartOpts=list(curves_xlab="Time (hours)", curves_ylab="Response",
                           scat1_xlab="Angle at 2 hrs", scat1_ylab="Angle at 4 hrs",
                           scat2_xlab="Angle at 4 hrs", scat2_ylab="Angle at 6 hrs",
                           color=c("yellow", "lightblue"), colorhilit=c("orange", "blue")))
```
