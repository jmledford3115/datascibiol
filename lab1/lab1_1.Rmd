...
## GitHub
[**GitHub**](www.github.com) is a file storage and management site used by programmers. Programmers upload code to repositories (folders) and make it publicly available. We will use Github to store our work in BIS 15.  
...
Find the class repository [BIS15-W20-DataScienceBiologists](https://github.com/jmledford3115/BIS15-W20-DataScienceBiologists) at github.com. Click the `Clone or download` button then `Download zip` to the desktop. When you open this .zip file you will see all of the class files.  

## Copy
Copy all of the files for lab 1 in  `BIS15-W20-DataScienceBiologists` and paste them into your repository on the desktop. This will allow you to make changes and take notes as we progress.  
