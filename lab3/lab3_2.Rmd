...
## `mutate_at`
This function is super helpful when changing aspects about scific columns. 
```{r}
fish %>% 
  mutate_at(vars(lakeid), as.factor)
```
...
Here I correct for the incorrectly added random characters - save this code, it's particularly useful!
```{r}
mammals_corr <- 
  mammals_ohno %>%
