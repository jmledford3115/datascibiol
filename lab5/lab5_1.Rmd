...
*Maybe go over the ggplot2 cheatsheet before going into creating a plot, such as the different plots that correspond with different kinds of data. Such as you cannot create a bar plot with solely continuous data.*
