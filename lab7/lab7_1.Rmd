...
<!--I was confused with exactly what a string is. What is the difference between a string and non-string input?-->
...
server <- function(input, output, session) {
  output$plot <- renderPlot({
    ggplot(iris, aes_string(x = input$x, y = input$y, color = "Species")) + geom_point() + theme_light(base_size = 18)
  })
...
<!-- this example was really helpful for me because it allowed me to make an app with one string input and a non-string input. But at the time in lab, I didn't really realize it. Maybe it would be helpful if this was noted in the example-->
