...
#How to find cephalopods seemed to trip a lot of people up. They tended to search for 'cephalopod', which is not unlogical, but not effective. I suppose we want them to examine the data but maybe give them a hist to think carefully about how they choose to filter for this data?
...
#Here you grouped by taxon which many of them didn't think to do. Perhaps a little hint here about being sure that the data we're producing is readable/useful? Might encourage them to think about grouping things into a more readable output? Just a thought.

**17. Use the data to do at least one exploratory analysis of your choice. What can you learn?**
#No real comment here, other than some of them did some fun things and I loved it!
