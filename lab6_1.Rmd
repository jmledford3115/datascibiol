...
homerange %>% 
  ...
  geom_bar()+
  labs(title = "Observations by Locomotion Type in Homerange Data",
       x = "Locomotion",
       fill= "Primary Method")
```
...
What does the distribution of body mass look like in the homerange data? When adjusting binwidth note that we are using `log10.mass`.
```{r}
homerange %>% 
...
## Practice
1. Make a histogram of `log10.hra`. Make sure to add a title. Feel free to experiment with different bin sizes.
```{r}
homerange %>% 
