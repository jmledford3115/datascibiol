...
```
## # A tibble: 6 × 71
##   Country Common…¹ ISSCA…² ISSCA…³ ASFIS…⁴ ASFIS…⁵ FAO m…⁶ Measure `1950` `1951`
##   <chr>   <chr>      <dbl> <chr>   <chr>   <chr>     <dbl> <chr>   <chr>  <chr> 
## 1 Albania Angelsh…      38 Sharks… 10903X… Squati…      37 Quanti… <NA>   <NA>  
## 2 Albania Atlanti…      36 Tunas,… 175010… Sarda …      37 Quanti… <NA>   <NA>  
## 3 Albania Barracu…      37 Miscel… 177100… Sphyra…      37 Quanti… <NA>   <NA>  
## 4 Albania Blue an…      45 Shrimp… 228020… Ariste…      37 Quanti… <NA>   <NA>  
## 5 Albania Blue wh…      32 Cods, … 148040… Microm…      37 Quanti… <NA>   <NA>  
## 6 Albania Bluefish      37 Miscel… 170202… Pomato…      37 Quanti… <NA>   <NA>  
## # … with 61 more variables: `1952` <chr>, `1953` <chr>, `1954` <chr>,
...
##   <chr>    <chr>     <dbl> <chr>   <chr>   <chr>     <dbl> <chr>   <chr>  <chr> 
## 1 Zanzibar Seerfi…      36 Tunas,… 175010… Scombe…      51 Quanti… <NA>   <NA>  
## 2 Zanzibar Sharks…      38 Sharks… 199XXX… Elasmo…      51 Quanti… <NA>   <NA>  
## 3 Zanzibar Snappe…      33 Miscel… 17032X… Lutjan…      51 Quanti… <NA>   <NA>  
## 4 Zanzibar Spinef…      33 Miscel… 174070… Siganu…      51 Quanti… <NA>   <NA>  
## 5 Zanzibar Tropic…      43 Lobste… 229010… Panuli…      51 Quanti… <NA>   <NA>  
## 6 Zanzibar Tunali…      36 Tunas,… 175XXX… Scombr…      51 Quanti… <NA>   <NA>  
## # … with 61 more variables: `1952` <chr>, `1953` <chr>, `1954` <chr>,
## #   `1955` <chr>, `1956` <chr>, `1957` <chr>, `1958` <chr>, `1959` <chr>,
## #   `1960` <chr>, `1961` <chr>, `1962` <chr>, `1963` <chr>, `1964` <chr>,
## #   `1965` <chr>, `1966` <chr>, `1967` <chr>, `1968` <chr>, `1969` <chr>,
