...
Let's load our processed data from the first part of this lab.
```{r, message = FALSE}
...
## Practice
1. Map the spider locations with a different type of base map. What happens if you try to use a google source map? Experiment with different display options for the points. 
```{r}
